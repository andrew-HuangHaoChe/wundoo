<template>
  <div>
    <div class="hunter_content_block">
      <div class="container custom-container-width">
        <div class="hunter_info_block pt-3">
          <div class="huntground_info">
            <p class="mb-0">神劍闖江湖粗乃玩 <span>參加的獵場</span></p>
          </div>
        </div>
                        ...
                        <div class="row w-100 mx-0">
                          ...
                          >
                            <img
                              ...
                              alt=""
                            />
                            <span class="hg-card-people"
                              >獵場人數: {{ item.number_of_people }}</span
                            >
                          </div>
                          <div
